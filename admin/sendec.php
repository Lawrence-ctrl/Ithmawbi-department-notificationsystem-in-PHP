...
if(isset($_POST['noti'])){
  ...
  if(!empty($_FILES['post_photo']['name'])){
            ...
            if(empty($errMsg)) {
              ...
              $query = $conn->query("INSERT INTO posts (post_adminid,post_content,post_photo,post_year,post_status,created_date,updated_date)VALUES('".$_SESSION['admin_id']."','$post_content','$filename','$q','3',now(),now())");
                }
            }else{
              foreach ($post_year as $q) {
              $query = $conn->query("INSERT INTO posts (post_adminid,post_content,post_year,post_status,created_date,updated_date)VALUES('".$_SESSION['admin_id']."','$post_content','$q','3',now(),now())");
              }
            }
        ...
        <div class="right_col" role="main">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>To EC <small>sub title</small></h2>
                  ...
                  <div class="x_content">
                   <div class="rush"> 
                    <form class="form-horizontal form-label-left" method="POST" action="sendec.php" enctype="multipart/form-data">
                       <?php if($errMsg){
