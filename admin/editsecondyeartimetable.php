...
include('adminauth.php');
    ...
    $do = $conn->query("SELECT * FROM timetable WHERE timetable_year_id = '2' AND timetable_day_id = '$day'");
    $query = $do->fetch_assoc();
    }else{
    $do = $conn->query("SELECT * FROM timetable WHERE timetable_year_id = '2' AND timetable_day_id = '1'");
    $day = 1;
    $query = $do->fetch_assoc();
    }
     if(isset($_POST['add'])){
      ...
      $ee = $conn->query("UPDATE timetable SET timeone='$timeone',timetwo='$timetwo',timethree='$timethree',timefour ='$timefour', timefive='$timefive',timesix = '$timesix' WHERE timetable_id = '$hiddenid'");
       if($ee){
         header("location:editsecondyeartimetable.php?succ");
       }
     }
?>
  <style type="text/css">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Edit Second Year Timetable</h3>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Edit Second Year Timetable</h2>
            ...
            <form action="editsecondyeartimetable.php" method="POST">
            ...
            <div class="col-md-7 col-xs-12 text-center" style="margin-bottom: 10px;">
                  ...
                  <form class="form-horizontal form-label-left" action="editsecondyeartimetable.php" method="POST">
                  ...
                  <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                          ...
                          <a href="secondyeartimetable.php" class="btn btn-info" name="back">Back</a>
                        </div>
                      </div>
                </form>
                  </div>
