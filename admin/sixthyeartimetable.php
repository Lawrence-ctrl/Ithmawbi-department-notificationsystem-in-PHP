          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Add Sixth Year Timetable</h3>
              </div>
                <div class="text-right">
                <a href="editsixthyeartimetable.php"><button class="btn btn-primary">Edit</button></a>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Add Sixth Year Timetable</h2>
                  ...
                  <div class="x_content">
                  <form class="form-horizontal form-label-left" action="sixthyeartimetable.php" method="POST">
                      <?php if($errMsg) {
