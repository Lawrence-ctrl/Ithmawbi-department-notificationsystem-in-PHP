<?php 
 ...
 include('functions.php');
     $hi = $conn->query("SELECT * FROM users WHERE year_id = '5'");
     $wow = $conn->query("SELECT * FROM users WHERE year_id = '5' AND status = '3'");
 ?>
<body id="page-top">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a style="text-decoration: none;" href="fifthyearec.php">Select Ec</a>
          </li>
          <li class="breadcrumb-item active">Fifth Year</li>
        </ol>
        <div class="row">
          <div class="col-lg-12">
