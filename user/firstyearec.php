<?php 
 ...
 include('functions.php');
     $hi = $conn->query("SELECT * FROM users WHERE year_id = '1'");
     $wow = $conn->query("SELECT * FROM users WHERE year_id = '1' AND status = '3'");
 ?>
<body id="page-top">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a style="text-decoration: none;" href="firstyearec.php">Select Ec</a>
          </li>
