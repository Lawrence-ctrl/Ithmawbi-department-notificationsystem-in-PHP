<?php 
  ...
  if(!empty($_FILES['noti_photo']['name'])){
            ...
            if(empty($errMsg)) {
              ...
              $query = $conn->query("INSERT INTO posts (post_adminid,post_userid,post_content,post_photo,post_year,post_status,created_date,updated_date)VALUES('0','".$_SESSION['userid']."','$noti_content','$filename','$q','2',now(),now())");
               }
            }else{
              foreach($post_year as $q) {
              $query = $conn->query("INSERT INTO posts (post_adminid,post_userid,post_content,post_year,post_status,created_date,updated_date)VALUES('0','".$_SESSION['userid']."','$noti_content','$q','2',now(),now())");
               }
            }
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- Breadcrumbs-->
        <ol class="breadcrumb">
          <li class="breadcrumb-item active"><a href="addstnoti.php" style="text-decoration: none;">To Students</a></li>
        </ol>
