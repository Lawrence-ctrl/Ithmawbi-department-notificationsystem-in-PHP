          ...
          <div class="card">
            <div class="card-header msg_head">
              <div class="d-flex bd-highlight">
                ...
                <div class="user_info">
                  <span>Chat with <?php echo $quer['username']?></span>
                </div>
              </div>
            </div>
            <div class="card-body msg_card_body chat_history" id="<?php echo $quer['userid']?>" >
            ...
            <div class="card-footer">
              <div class="input-group">
                ...
                <div class="input-group-append">
                  <span class="input-group-text send_btn"><i class="fas fa-location-arrow fa-lg send_message" data-id=<?php echo $quer['userid']?>></i></span>
                </div>
              </div>
            </div>
          </div>
