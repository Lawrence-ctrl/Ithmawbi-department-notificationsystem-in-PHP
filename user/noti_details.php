      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            ...
            <li class="breadcrumb-item active"><a href="notifications.php">Alerts</a></li>
        </ol>
      <div class="row">
                       ...
                       <tr>
                         ...
                         if($result->num_rows > 0) : ?>
                          ...
                          <td><i class="fas fa-eye text-info fa-md eye" title="Watch Viewers" data-toggle="modal" data-target="#viewModal" id="<?php echo $value['post_id']?>"></i></td>
                            <td><a href="index.php" style="text-decoration:none;"><i class="fas fa-search-minus text-info fa-md" title="Zoom Out" id="<?php echo $value['post_id']?>"></i></a></td>
                       </tr>
                   </table>
                </div>
              </div>
